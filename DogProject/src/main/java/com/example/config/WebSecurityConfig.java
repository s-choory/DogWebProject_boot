...
import com.example.config.filter.CustomAuthenticationFilter;
import com.example.config.handler.CustomAuthFailureHandler;
import com.example.config.handler.CustomAuthSuccessHandler;
import com.example.config.handler.CustomAuthenticationProvider;
...
//				.antMatchers("/login","/", "/mypage").permitAll()
//                // USER, ADMIN 접근 허용
...
//        http.addFilterBefore(jwtAuthorizationFilter(), BasicAuthenticationFilter.class);
    ...
    public CustomAuthenticationFilter customAuthenticationFilter() {
        ...
        customAuthenticationFilter.setFilterProcessesUrl("/app/v1/user/login");     // 접근 URL
