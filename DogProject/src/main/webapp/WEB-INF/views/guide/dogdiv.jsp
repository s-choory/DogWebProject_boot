...
//data-xxx= Num 
for(int i = 1; i <= a; i++) { %>
<div style="border: 1px solid white; background-color: silver; padding: 10px; margin-left:auto; margin-right:auto; width: 70%;" class="list" data-xxx="<%=i%>" align="center" id="home2"  >
	<img src="images/items/sun.png" border="0"  width="10%" style="float: left; margin-right: 20px;" id="image<%=i%>">
	<div style="display: inline-block; width: calc(50% - 25% - 20px); ">
		<span id="address<%=i%>" style="display:block; margin-top: 10px;">주소<%=i%></span>
	</div>
	<div style="display: inline-block; width: calc(25% - 20px); ">
		<span id="info<%=i%>" style="display: block; margin-top: 10px;">
			정보<%=i%><br>
			카테고리: 식당or카페 <br>
