...
function UpdateOrderState(OrderID) {
	if (confirm("정말 "+OrderID+"번 주문을 입금 확인 하겠습니까?") == true) {
		location.href="adminUpdateOrderState?OrderID="+OrderID;
	}
}
...
<body>
    ...
    <div style="text-align: center; margin-bottom: 30px;">
    	...
    	<a href="adminOrderListConfirm" > 주문 결제완료 목록으로 이동</a><br><br>
	</div>
    ...
    <table class="table">
    	...
    	<tr class="table-light">
    		...
    		<td class="action2"><button class="btn btn-primary" onclick="UpdateOrderState(<%=oDTO.getOrderID()%>)">입금확인</button></td>
    	</tr>
    	<%} %>
    </table>
    </div>
